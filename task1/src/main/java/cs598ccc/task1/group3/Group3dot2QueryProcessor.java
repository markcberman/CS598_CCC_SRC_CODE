...
public class Group3dot2QueryProcessor {

    private static Logger logger = Logger.getLogger(Group3dot2QueryProcessor.class);

    public static void main(String[] args) {
        logger.info("Starting Group 3 Queries");
        Group3dot2QueryProcessor app = new Group3dot2QueryProcessor();
        app.start();
    }
